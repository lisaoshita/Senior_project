...
# converting data frame to xgb.DMatrix (recommended)
...
n_round <- 50
xgb_cv <- xgb.cv(params = params, data = dtrain,
                 nfold = 5, nrounds = n_round, 
                 maximize = TRUE, print_every_n = 10, 
                 early_stop_round = 2, prediction = TRUE)

oof_prediction <- data.frame(xgb_cv$pred)
```
